...
- V9 uses WebAssembly for the Census popcount microkernel. V10 additionally solves bounded per-frame turntable angle errors and axis tilt, evaluates depth through a true 1×/½/¼ image pyramid, raises Worker depth density, and uses a compiled WebAssembly SIMD module for ZNCC and TSDF numeric reductions. Camera projection, patch/voxel traversal and surface extraction remain deterministic TypeScript inside the Worker.
