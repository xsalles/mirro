...
- BodyCalibration v8 can additionally derive eight confidence-weighted depth maps with classical ZNCC correspondence, reject cross-view inconsistencies, and fuse a render TSDF. The TSDF may only carve inward relative to the v7 envelope; garment collision still uses the conservative SDF.
