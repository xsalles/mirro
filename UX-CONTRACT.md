...
- Body calibration metadata, reusable optical parameters, visual-hull surface/occupancy, advanced measurements and BodyMesh arrays are local IndexedDB state. New fully targeted calibrations persist BodyMesh v3; v2/v1 remain readable.
